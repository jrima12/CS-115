...
01 jeqzn r1 19   # if r1 = 0 then jump straight to halt (line 19)
...
06 jeqzn r1 19   # now if r1 is 0, go to halt (line 19)
07 write r3      # write the second element, stored in r3 (1)
08 addn r1 -1    # subtract 1 from r1
09 jeqzn r1 19   # now if r1 is 0, go to halt (line 19)
10 add r2 r2 r3  # add contents of r2 and r3 and store them in r2
11 write r2      # print out r2
12 addn r1 -1    # subtract 1 from r1
13 jeqzn r1 19   # if r1 is 0, go to halt (line 19)
14 add r3 r2 r3  # add contents of r2 and r3 and store them in r3
15 write r3      # print out r3
16 addn r1 -1    # subtract 1 from r1
17 jeqzn r1 19   # if r1 is 0, go to halt (line 19)
18 jumpn 10      # repeat process
19 halt          # end
